...
程序使用 HSV 色彩空间进行颜色识别，结合 K-means 聚类分析图片颜色分布，动态调整阈值识别少数派颜色块。

**冷暖色识别方法来源**：[知乎专栏 - 色弱图谱识别算法详解](https://zhuanlan.zhihu.com/p/111698280)
...
程序使用先进的颜色分布分析，能够准确识别色弱图谱中的少数派颜色块。以下是测试示例：
...
### 错题库示例（正确识别数字88）
![错题库识别效果](downloaded_images/错题库/俞自萍第五版_004_result.jpg)
